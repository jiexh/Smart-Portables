...
public class CheckOut extends HttpServlet {
    ...
    protected void storeOrders(HttpServletRequest request, HttpServletResponse response) throws IOException {
        response.setContentType("text/html");
        PrintWriter pw = response.getWriter();
        ...
        for (CartItem oi : cartItems) {
            ...
            pw.print("<input type='hidden' name='itemId' value='" + oi.getItemId() + "'>");
            pw.print("Product Price:</td><td>" + oi.getPrice());
            pw.print("</td></tr>");
        }

        pw.print("<tr><th>");
        pw.print("Total Order Cost</th><th>" + orderTotal);
        pw.print("<input type='hidden' name='orderTotal' value='" + orderTotal + "'>");
        pw.print("</th></tr></table><table><tr></tr><tr></tr>");
        pw.print("<tr><td>");
        pw.print("Customer Name</td>");
        pw.print("<td><input type='text' name='customerName' required>");
        pw.print("</td></tr>");
        pw.print("<tr><td>");
        ...
        pw.print("<td><input type='text' name='userAddress' required>");
        pw.print("</td></tr>");
